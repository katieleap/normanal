...
shinyUI(fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      conditionalPanel(condition = "(input.rhosigmab == 'ICC' & input.options == 'useCV' || input.options.length > 1)
                                     || (input.rhosigmab == 'sigmab' & input.optionsb ==  'useCVb' || input.optionsb.length > 1)",
    ...
    mainPanel(
      tabsetPanel(id = "tabpanel",
        tabPanel("Table",
                 ...
                 br(), br(),
                 conditionalPanel(condition="input.calc",
                 p("Abbreviations:"),
        ...
        tabPanel("Plot",
                 ...
                 plotOutput("plot"),
                 br(),
                 downloadButton("downloadimg",label="Download as PNG File")),
